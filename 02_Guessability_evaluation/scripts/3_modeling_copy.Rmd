...
**Random effects**:
```{r eval=FALSE, fig.cap=capFig("Posterior estimates of the random effects showing the median (dot), 50% (thick line) and 95% (thin lines) quantiles. Also showing 0 as the vertical dotted line and negative (blue) vs positive (red) values."), fig.height=1*7, fig.width=1*4, warning=FALSE, include=FALSE, results='hide'}
...
(The chunk above, cause unknown, is problematic to knit, therefore it is not shown, but the code below should warrant the interpretation.)
