...
data = read.csv(paste0(folderdata, "/001324_expressibility_dutch.csv"))

# Write another column 'file' with a filename
data$file = '001324_expressibility_dutch.csv'
...
# Delete pilot 
data <- data %>% filter(exp_ID != 232400 & exp_ID != 254289 & exp_ID != 682241 & exp_ID != 148688 & exp_ID != 582962 & exp_ID != '%SURVEY_CODE%')
